...
import net.agilhard.maven.plugins.jpacktool.base.mojo.jpackager.JPackagerMojo;

/**
 * The JPackager goal can create a native installer packages based on
 * <a href=
 * "http://openjdk.java.net/jeps/343">http://openjdk.java.net/jeps/343</a>.
 *
 * @author Bernd Eilers
 */
...
public class JPacktoolJPackagerMojo extends JPackagerMojo {

	public JPacktoolJPackagerMojo() {
